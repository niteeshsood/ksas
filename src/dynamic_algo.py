...
class Controller():
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.path_file = '/home/niteesh/paths/x_0_z_3_path.csv'
        self.maxind = 0
        self.path_list = list()
        #Total pose counter
        self.tpose_count = 0
        self.unset_tpose_count = 3
...
Point, queue_size=10)
        ...
        pub_onoff = rospy.Publisher('reached', Int32, queue_size=10)
...
#        return lambda theta:  np.matrix( [ [cos(theta), -sin(theta)], [sin(theta), cos(theta)]]
    ...
    def find_lateral_basis_and_error(self):
        ...
        try:
            ...
            rospy.logwarn('Robot cannot detect d. !!Stopping!!')
            self.send_off_ = True
	...
	#Let's shift the coordinate axes
        ...
        else:  rospy.loginfo('Turn anti-clockwise')
