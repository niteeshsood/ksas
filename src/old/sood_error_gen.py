...
#                rospy.loginfo('Publishing')
    ...
    def find_lateral_error(self):
        ...
        #Calculate it here
        if minind == self.maxind:
            rospy.loginfo('Robot believes it is at the end of path')
    ...
    def fill_control_msg(self):
        ...
        self.ard_msg = str_laterr_msg + '|' + str_prperr_msg + '|' + str_dir_msg
        #rospy.loginfo(self.ard_msg)
